...
<body>
    ...
    <h2 class="m-2 text-center">Kategori</h2>

    <div class="container" id="kategori-list">
        <div class="row">
    ...
    <script>
                ...
                success: function(response) {
                    ...
                    $.each(response,function(i,v){
                        ...
                        $('tbody').append(' <tr>\
                            ...
                            <td> <button class="btn btn-secondary btn-edit" data-nama="'+v.nama_kategori+'" data-id="'+v.id_kategori+'" data-toggle="modal" data-target="#modalEdit">Edit</button>  <button class="btn btn-danger btn-delete" data-id="'+v.id_kategori+'" data-toggle="modal" data-target="#modalDel">delete</button> </td>\
                        </tr>');
                    })
                },
        ...
        //edit
            $('tbody').on('click','.btn-edit',function(){
                ...
                $('#modalEdit').find('#nama_kategori').val(nama_kategori);
                $('#modalEdit').find('#data_id').val(data_id);
            });

            $('.btn-simpan-edit').on('click', function () {
                let nama_kategori=$('#modalEdit').find('#nama_kategori').val();
        ...
        //create
            $('.btn-simpan-add').on('click', function () {
                let nama_kategori=$('#modalAdd').find('#nama_kategori').val();
            ...
            $('#modalAdd').on('hidden.bs.modal', function () {
                $('#modalAdd').find('#nama_kategori').val('');
            });
        //
